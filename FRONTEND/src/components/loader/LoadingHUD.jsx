        ...
        {!isLoaded ? (
          <div className="space-y-8 max-w-md mx-auto">
            ...
            <div className="w-full h-px bg-white/10 rounded-full overflow-hidden">
              <div
                className="h-full bg-diner-crimson transition-all duration-300 ease-out shadow-[0_0_15px_var(--color-diner-crimson)]"
                style={{ width: `${displayProgress}%` }}
              />
            </div>
            <p className="text-diner-crimson/40 text-[10px] font-bold tracking-[0.3em] uppercase">
              {isPausedAtCritical
          ...
          <div className="flex flex-col items-center gap-8 pointer-events-auto">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
              <button
                ...
                className="group relative px-12 py-6 bg-white/5 border border-white/10 rounded-full backdrop-blur-3xl transition-all duration-700 hover:bg-diner-crimson/5 hover:border-diner-crimson/30 hover:scale-105 active:scale-95 cursor-pointer overflow-hidden shadow-2xl"
              >
                <div className="relative z-10 flex items-center gap-5">
                  <div className="p-3 bg-diner-crimson/10 rounded-full group-hover:bg-diner-crimson/20 transition-colors shadow-inner">
                    <Lock size={20} className="text-diner-crimson" />
                  </div>
