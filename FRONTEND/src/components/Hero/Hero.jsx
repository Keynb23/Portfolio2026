...
const Hero = () => {
  ...
  /> */}
          ...
          <div
            className="relative z-20 m-8 p-12 rounded-lg backdrop-blur-xs backdrop-saturate-200 
                  bg-clip-padding"
          >
          ...
          <div className="hero__cta z-2 flex gap-4 items-center">
            {/* Primary: Blue background, Yellow text -> Swaps on hover */}
            <a
              href="#work"
            ...
            {/* Secondary: Ghost Style (No BG), White text -> Yellow text on hover */}
            <a
              href="#contact"
